...
public class GattService {
	...
	// UMHD-XXXX 
	public static final UUID UMEDIA_KEY_EVENT =  new UUID((0xffe0L << 32) | 0x1000, GattUtils.leastSigBits);
	
	// 埃微  I5 運動手環
	public static final UUID I5_CONFIGURATION = UUID.fromString("f000ff10-0451-4000-b000-000000000000");
	public static final UUID I5_DATA_SERVICE = UUID.fromString("f000ff00-0451-4000-b000-000000000000");
	
	// 天天手環
	public static final UUID M04L_SERVICE1 = new UUID((0xfef5L << 32) | 0x1000, GattUtils.leastSigBits);
	public static final UUID M04L_SERVICE2 = new UUID((0x55ffL << 32) | 0x1000, GattUtils.leastSigBits);
	...
	static {
		...
		// UMHD-XXXX		
		attributes.put(UMEDIA_KEY_EVENT, "Umedia Key Event Service");
		
		//埃微 I5 運動手環
		attributes.put(I5_CONFIGURATION, "I5 Configuration Service");
		attributes.put(I5_DATA_SERVICE, "I5 Data Service");
		
		// 天天手環
		attributes.put(M04L_SERVICE1, "M04_L Service 1");
		attributes.put(M04L_SERVICE2, "M04_L Service 2");
    }
