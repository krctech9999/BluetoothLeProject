...
public class ManufacturerName extends DeviceGattCharacteristic {

	private String str;
	public ManufacturerName(BluetoothGattService gattservice,
	...
	public HashMap<String, Object> getData() {
		...
		data.put(BluetoothLeCharacteristicKey.KEY_MANUFACTURER_NAME, str);
		return data;
	}
